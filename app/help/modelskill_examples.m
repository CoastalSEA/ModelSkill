...
% when loading a timeseries. 
%
% There are also a set of grids that provide a timeseries from a model for the
% morphological development of a tidal inlet. The Inlet_demo.mat file in the same 
% folder contains the inlet data already loaded.
